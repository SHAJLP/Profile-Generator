...
const generateManagerCard = (manager) => {
    ...
    <div class="card-body">
      ...
      <p class="card-text">If you wish to get in touch, please do so via my eamil</p>
  ...
  const generateEngineerCard = (engineer) => {
    ...
    <div class="card-body">
      ...
      <p class="card-text">
        I f you wish to collaborate, please do get in touch
      </p>
  ...
  const generateInternCard = (intern) => {
    ...
    <div class="card-body">
      ...
      <p class="card-text">
        Contact me if you would like to discuss my projects
      </p>
